...
void index_string(safe_que<std::string> &queue, safe_que<std::unordered_map<std::string, int>> &merge_q_n, safe_que<std::unordered_map<std::string, int>> &merge_q_n_1, const std::string &ext, int n);
