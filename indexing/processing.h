...
void count_ngrams(std::unordered_map<std::string, int> &phrase_map_n, std::unordered_map<std::string, int> &phrase_map_n_1, std::unordered_map<std::string, int> dict_eng, const std::string &line);

void parallel_merge_maps(safe_que<std::unordered_map<std::string, int>> &mer_q);

void index_string(safe_que<std::string> &queue, safe_que<std::unordered_map<std::string, int>> &merge_q_n, safe_que<std::unordered_map<std::string, int>> &merge_q_n_1, std::unordered_map<std::string, int> dict_eng, const std::string &ext, int n);
