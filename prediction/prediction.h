...
void string_to_probabilities_map_parallel(oneapi::tbb::concurrent_hash_map<std::string, double> &probabilities_map,
...
void string_to_next_words_map_parallel(oneapi::tbb::concurrent_hash_map<std::string, std::vector<std::string>> &words_map,
